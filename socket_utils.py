...
Socket.IO 工具模块
用于处理实时通知功能，避免循环导入问题
注意：Vercel 不支持 WebSocket，此模块已禁用
"""
...
def notify_page_refresh(page, data):
    """
    通知指定页面刷新
    注意：Vercel 不支持 WebSocket，此功能已禁用
